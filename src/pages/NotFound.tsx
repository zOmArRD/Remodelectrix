            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        <h1
                            className="text-4xl font-bold tracking-tight sm:text-6xl text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400"
                        >
                            Sorry, we did not find what you were looking for
                        </h1>
                        <p className="mt-6 text-lg leading-8">
                            Don't worry. You can go back to the previous page or go to the home page. </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <a href="/" className="text-sm font-semibold leading-6 text-with-underline">
                                Go to Remodelectrix <span aria-hidden="true">→</span>
                            </a>
                        </div>
                    </div>
                </div>
